\begin{figure}[htbp]
    ...
    \begin{axis}[
        ...
        \addplot coordinates {(Vector RAG,0.7889) (Subgraph,0.7539) (Hybrid,0.7620)};
        \addlegendentry{Faktual}
        \addplot coordinates {(Vector RAG,0.2575) (Subgraph,0.2097) (Hybrid,0.2567)};
        \addlegendentry{Relasional}
        \addplot coordinates {(Vector RAG,0.1881) (Subgraph,0.1167) (Hybrid,0.1923)};
