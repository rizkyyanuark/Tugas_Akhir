...
\begin{enumerate}[label=\textbf{\arabic*.}, leftmargin=*, itemsep=10pt]
    ...
    \item \textbf{Persiapan Data (\textit{Data Preparation})}
          ...
          \begin{enumerate}[label=\textbf{\alph*.}, leftmargin=0.75cm, itemsep=4pt]
              ...
              \item \textbf{\textit{Text Chunking} (Pemotongan Teks):} Judul, abstrak, TLDR, dan kata kunci publikasi disusun menjadi unit teks akademik yang siap diindeks. Pada implementasi, potongan teks dibatasi sekitar 2.024 karakter dengan \textit{overlap} 50 karakter agar bukti tekstual tetap cukup utuh ketika digunakan sebagai konteks jawaban.

              \item \textbf{\textit{Embedding Generation}:} Setiap \textit{chunk} dikonversi menjadi vektor berdimensi 1.024 menggunakan model \texttt{Qwen/Qwen3-Embedding-0.6B}. Vektor ini digunakan untuk pencarian semantik pada vector database sehingga sistem tidak hanya bergantung pada pencocokan kata kunci leksikal.
          \end{enumerate}
              ...
              \item \textbf{\textit{Parallel Processing Pipeline}}
                    ...
                    \begin{enumerate}[label=\textbf{\alph*.}, leftmargin=0.75cm, itemsep=5pt]
                        ...
                        \item \textbf{Jalur Data Tidak Terstruktur: \textit{NLP-Based Extraction}}
                              ...
                              \hspace*{0.75cm}Ekstraksi entitas tidak terstruktur diarahkan menggunakan \textit{GLiNER} \cite{zaratiana2023gliner} dengan keunggulan teknik \textit{zero-shot Named Entity Recognition}. Entitas yang ditemukan dipetakan ke skema ontologi penelitian, seperti \textit{Method}, \textit{Model}, \textit{Dataset}, \textit{Metric}, \textit{Domain}, atau \textit{ResearchTopic}. Setelah tipe entitas jelas, relasi dibentuk secara deterministik mengikuti ontologi, misalnya \texttt{USES\_MODEL}, \texttt{EVALUATED\_WITH}, \texttt{USES\_METHOD}, \texttt{HAS\_TOPIC}, dan \texttt{BELONGS\_TO\_DOMAIN}.
              ...
              \item \textbf{\textit{Dual Indexing}}
                    ...
                    \begin{enumerate}[label=\textbf{\alph*.}, leftmargin=0.75cm, itemsep=5pt]
                        \item \textbf{\textit{Vector Indexing}}
                              ...
                              \hspace*{0.75cm}Teks publikasi dipotong menjadi segmen 2.024 karakter dengan \textit{overlap} 50 karakter, dikonversi ke vektor \textit{embedding} menggunakan \texttt{Qwen/Qwen3-Embedding-0.6B} (1.024 dimensi), dan disimpan di Zilliz/Milvus untuk pencarian kemiripan semantik. Indeks vektor dipisahkan menjadi empat koleksi: \texttt{PaperChunk}, \texttt{EntityEmbedding}, \texttt{RelationshipEmbedding}, dan \texttt{ContentKeyword}.
