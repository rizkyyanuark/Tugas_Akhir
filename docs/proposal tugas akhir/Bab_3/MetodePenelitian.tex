...
\tikzset{
    ...
    subbox/.style={draw=orange!70!black, line width=0.7pt, rounded corners=3pt, fill=orange!5, inner sep=7pt}
}
...
\begin{enumerate}[label=\textbf{\arabic*.}, leftmargin=*, itemsep=10pt]
    ...
    \item \textbf{Pengumpulan Data (\textit{Data Collection})}
          ...
          \begin{figure}[htbp]
              \centering
              \begin{adjustbox}{max width=0.88\textwidth, max totalheight=0.66\textheight, center}
    ...
    \item \textbf{Persiapan Data (\textit{Data Preparation})}
          ...
          \begin{figure}[htbp]
              ...
              \begin{adjustbox}{max width=0.88\textwidth, max totalheight=0.66\textheight, center}
              \begin{tikzpicture}[scale=1, transform shape]
                  \node [subbox, fit={(-0.6,0.2) (4.4,-6.3)}, label={[font=\scriptsize\bfseries]above:Detail Data Preparation}] {};
    ...
    \item \textbf{Konstruksi \textit{Knowledge Graph}}
          ...
          \begin{figure}[htbp]
              ...
              \begin{tikzpicture}[x=0.9cm, y=0.74cm]
              ...
              \item \textbf{\textit{Parallel Processing Pipeline}}
                    ...
                    \begin{enumerate}[label=\textbf{\alph*.}, leftmargin=0.75cm, itemsep=5pt]
                        ...
                        \item \textbf{Jalur Data Tidak Terstruktur: \textit{NLP-Based Extraction}}
                              ...
                              \hspace*{0.75cm}Selanjutnya, jalur \textbf{Ekstraksi Entitas dan Relasi} menyediakan \textit{GLiNER} \cite{zaratiana2023gliner} untuk \textit{Named Entity Recognition} secara \textit{zero-shot} dan \textit{GLiRel} \cite{boylan2025glirelgeneralistmodel} untuk ekstraksi relasi. Kombinasi ini dipilih karena tidak memerlukan dataset pelatihan teranotasi. Ketika konfigurasi ekstraksi diaktifkan, keluarannya berupa \textit{Lexical Graph} berisi triplet kandidat; ketika dinonaktifkan, konstruksi menggunakan metadata, kata kunci penulis, aturan, dan kosakata terkendali sebagai \textit{baseline}.
    ...
    \item \textbf{Implementasi GUI (\textit{GUI Implementation})}
          ...
          \hspace*{0.75cm}Antarmuka pengguna (\textit{Graphical User Interface}) dikembangkan sebagai aplikasi web menggunakan Vue 3 dan Vite pada sisi klien serta FastAPI pada sisi layanan. Antarmuka memfasilitasi percakapan dengan agen, menampilkan sumber jawaban, dan menyediakan visualisasi \textit{knowledge graph}. Pemisahan klien dan layanan memungkinkan proses \textit{retrieval}, generasi, dan akses penyimpanan dijalankan pada sisi server tanpa mengekspos kredensial kepada pengguna.
\end{enumerate}
