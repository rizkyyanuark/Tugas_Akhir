...
async def extract_keywords_with_clues(
    query: str,
    weaviate_storage: WeaviateVectorStorage,
    llm: LLMAdapter,
    ...
    Args:
        ...
        weaviate_storage: Weaviate vector storage adapter.
    ...
    """
    # Step 1: Get keyword clues from Weaviate ContentKeyword collection
    clue_results = weaviate_storage.query_keywords(query, top_k=top_k)
