...
async def test_txt_add_vector_entity_parsing():
    ...
    with patch("yunesa.models.select_embedding_model") as mock_select_model:
        ...
        # The import is `from yunesa import config`, so patch at the usage location
        ...
        with patch("yunesa.knowledge.graphs.upload_graph_service.config", mock_config):
