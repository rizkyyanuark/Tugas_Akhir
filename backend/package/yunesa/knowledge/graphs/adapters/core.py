...
class CoreGraphAdapter(GraphAdapter):
    """Core Graph Adapter for accessing structured graph data from Neo4j"""
    ...
    def __init__(self, graph_db_instance=None, config: dict[str, Any] = None):
        ...
        if graph_db_instance and hasattr(graph_db_instance, "_service"):
            ...
            self.service = graph_db_instance if graph_db_instance else CoreGraphService()
