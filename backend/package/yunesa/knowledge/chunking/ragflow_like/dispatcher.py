...
from yunesa.knowledge.chunking.ragflow_like.parsers import book, general, laws, qa
from yunesa.knowledge.chunking.ragflow_like.presets import map_to_internal_parser_id, normalize_chunk_preset_id
...
def chunk_file(
    ...
    # Files are converted to markdown before indexing, so reuse chunk_markdown.
