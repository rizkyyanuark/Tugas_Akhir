...
def _paper_extract_scopus(config):
    ...
    from yunesa.etl.services.paper_paths import (
        LEGACY_SCOPUS_CSV,
        LEGACY_SCOPUS_RAW_CSV,
        SCOPUS_CSV,
        SCOPUS_RAW_CSV,
    )
    from yunesa.etl.services.unesa_papers import run_scopus_scraping
...
def _paper_extract_scholar(config):
    ...
    from yunesa.etl.services.paper_paths import LEGACY_SCHOLAR_CSV, SCHOLAR_CSV
    from yunesa.etl.services.unesa_papers import run_scholar_scraping
...
def _paper_enrich(config):
    ...
    from yunesa.etl.services.unesa_papers import run_paper_enrichment
...
def _paper_load(config):
    ...
    from yunesa.etl.services.paper_paths import PAPER_ENRICHED_CSV, PAPER_SAMPLE_MERGED_CSV
    from yunesa.etl.services.unesa_papers import run_supabase_insert
