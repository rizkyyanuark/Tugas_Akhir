...
from yunesa.etl.clients.scholar_client import ScholarClient
from yunesa.etl.clients.supabase_client import SupabaseClient
...
from yunesa.etl.utils.logging import log_error, log_event, log_warning
from yunesa.etl.transform.enricher import (
    enrich_paper_batch,
...
def run_scopus_scraping(
    ...
    from yunesa.etl.clients.scopus_client import ScopusPaperClient
...
def run_supabase_insert(
    ...
    try:
        from yunesa.etl.clients.postgres_client import PostgresClient
        from yunesa.etl.transform.cleaner import clean_papers_batch
