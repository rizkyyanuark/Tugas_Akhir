...
Airflow calls this module from DockerOperator with commands such as:
    ...
    python -m yunesa.etl.run_worker lec_extract_web --mode incremental
...
from yunesa.etl.config import ETL_RUN_MODE, ETL_SAMPLE_SIZE
from yunesa.etl.utils.logging import configure_etl_logging, log_error, log_event, timed_event
from yunesa.etl.worker import RunConfig, TASK_CHOICES, TASK_REGISTRY as TASK_REGISTRY, dispatch_task
