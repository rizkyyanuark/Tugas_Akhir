...
- Use `retrieval_mode="graph"` when the user asks specifically about relationships or connected entities.
...
Lecturer, Publication, Venue, Year, Keyword, Concept.
Concept can represent ResearchTopic, Task, Domain, Method, Model, Dataset, or Metric.
Important relations include PUBLISHES, HAS_AUTHOR, PUBLISHED_IN_VENUE, PUBLISHED_IN_YEAR,
