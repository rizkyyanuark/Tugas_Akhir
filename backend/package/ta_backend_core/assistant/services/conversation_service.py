...
from ta_backend_core.assistant.config import config as app_config
from ta_backend_core.assistant.plugins.parser import Parser
...
from ta_backend_core.assistant.utils.paths import VIRTUAL_PATH_UPLOADS
