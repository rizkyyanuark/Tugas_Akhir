...
from ta_backend_core.assistant.repositories.skill_repository import SkillRepository
from ta_backend_core.assistant.services.mcp_service import get_enabled_mcp_server_names
from ta_backend_core.assistant.storage.postgres.models_business import Skill
...
def get_builtin_skill_specs() -> list[Any]:
    from ta_backend_core.assistant.agents.skills.buildin import BUILTIN_SKILLS
