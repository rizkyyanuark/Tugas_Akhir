...
from ta_backend_core.assistant.utils.evaluation_metrics import EvaluationMetricsCalculator
...
class EvaluationService:
    ...
    async def _generate_benchmark_task(self, context: TaskContext):
        ...
        from ta_backend_core.assistant.models import select_embedding_model, select_model
