...
from ta_backend_core.assistant.repositories.agent_run_repository import TERMINAL_RUN_STATUSES, AgentRunRepository
from ta_backend_core.assistant.repositories.conversation_repository import ConversationRepository
from ta_backend_core.assistant.services.run_queue_service import (
    get_arq_pool,
...
async def get_active_run_by_thread(*, thread_id: str, current_user_id: str, db: AsyncSession) -> dict:
    ...
    from ta_backend_core.assistant.storage.postgres.models_business import AgentRun
