...
from ta_backend_core.assistant.storage.postgres.models_business import Base as BusinessBase
from ta_backend_core.assistant.storage.postgres.models_knowledge import Base as KnowledgeBase
