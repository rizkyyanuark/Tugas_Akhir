...
from ta_backend_core.assistant.knowledge.chunking.ragflow_like.presets import (
    ensure_chunk_defaults_in_additional_params,
    resolve_chunk_processing_params,
)
from ta_backend_core.assistant.knowledge.utils import sanitize_processing_params
from ta_backend_core.assistant.utils import logger
from ta_backend_core.assistant.utils.datetime_utils import coerce_any_to_utc_datetime, utc_isoformat
...
class KnowledgeBase(ABC):
    ...
    async def add_file_record(
        ...
        """
        from ta_backend_core.assistant.knowledge.utils.kb_utils import prepare_item_metadata
    ...
    async def create_database(
        ...
        **kwargs,
        ...
        Returns:
            数据库信息字典
        """
        from ta_backend_core.assistant.utils import hashstr
    ...
    async def _load_metadata(self) -> None:
        from ta_backend_core.assistant.repositories.evaluation_repository import EvaluationRepository
        from ta_backend_core.assistant.repositories.knowledge_base_repository import KnowledgeBaseRepository
