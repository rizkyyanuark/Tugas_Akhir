...
from ta_backend_core.assistant.knowledge.graphs.adapters.base import BaseNeo4jAdapter
...
class UploadGraphAdapter(GraphAdapter):
    ...
    def __init__(self, graph_db_instance=None, config: dict[str, Any] = None):
        ...
        # 延迟导入以避免循环导入
        from ta_backend_core.assistant.knowledge.graphs.upload_graph_service import UploadGraphService
