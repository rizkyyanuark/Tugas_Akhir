...
from ta_backend_core.assistant.knowledge.base import FileStatus, KnowledgeBase
from ta_backend_core.assistant.knowledge.chunking.ragflow_like.dispatcher import chunk_markdown
from ta_backend_core.assistant.knowledge.chunking.ragflow_like.presets import resolve_chunk_processing_params
from ta_backend_core.assistant.knowledge.utils.kb_utils import get_embedding_config
from ta_backend_core.assistant.models.embed import OtherEmbedding
from ta_backend_core.assistant.plugins.parser.unified import Parser
from ta_backend_core.assistant.utils import hashstr, logger
...
class MilvusKB(KnowledgeBase):
    ...
    def _get_async_embedding(self, embed_info: dict):
        ...
        if embed_info and "model_id" in embed_info:
            from ta_backend_core.assistant.models.embed import select_embedding_model
    ...
    async def aquery(self, query_text: str, db_id: str, agent_call: bool = False, **kwargs) -> list[dict]:
        ...
        try:
            ...
            try:
                from ta_backend_core.assistant.models.rerank import get_reranker
