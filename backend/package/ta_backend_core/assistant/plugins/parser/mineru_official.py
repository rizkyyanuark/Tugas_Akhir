...
from ta_backend_core.assistant.plugins.parser.base import BaseDocumentProcessor, DocumentParserException
from ta_backend_core.assistant.plugins.parser.zip_utils import process_zip_file_sync
