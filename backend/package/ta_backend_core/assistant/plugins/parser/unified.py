...
from ta_backend_core.assistant.plugins.parser.zip_utils import process_zip_file as _process_zip_file
...
def parse_pdf(file, params=None):
    ...
    from ta_backend_core.assistant.plugins.parser.base import DocumentProcessorException
...
async def _process_file_to_markdown_core(
    ...
    from ta_backend_core.assistant.knowledge.utils.kb_utils import is_minio_url, parse_minio_url
