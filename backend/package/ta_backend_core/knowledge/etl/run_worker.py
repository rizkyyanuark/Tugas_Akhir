...
def main():
    ...
    try:
        if args.task == "extract_scholar":
            from ta_backend_core.knowledge.etl.services.unesa_papers import run_scholars_extraction
            ...
            from ta_backend_core.knowledge.etl.services.unesa_papers import run_scopus_extraction
            result = run_scopus_extraction()
            logger.info(f"✅ extract_scopus complete → {result}")

        elif args.task == "merge":
            from ta_backend_core.knowledge.etl.services.unesa_papers import run_merge
            from ta_backend_core.knowledge.etl.config import RAW_DATA_DIR
            ...
            from ta_backend_core.knowledge.etl.services.unesa_papers import run_enrichment
            from ta_backend_core.knowledge.etl.config import PROCESSED_DATA_DIR
            ...
            from ta_backend_core.knowledge.etl.services.unesa_papers import run_transform
            from ta_backend_core.knowledge.etl.config import PROCESSED_DATA_DIR
            ...
            from ta_backend_core.knowledge.etl.services.unesa_papers import run_database_commit
            from ta_backend_core.knowledge.etl.config import PROCESSED_DATA_DIR
