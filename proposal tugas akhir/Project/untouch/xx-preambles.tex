...
% Mengatur indentasi paragraf (default untuk section)
...
\titleformat{\subsection}{\fontsize{12}{14}\bfseries}{\thesubsection}{0.2cm}{}

% Mengatur jarak dan format spacing untuk chapter, section dan subsection
\titlespacing*{\chapter}{0pt}{-1cm}{15pt}
\titlespacing*{\section}{0pt}{10pt}{0cm}
\titlespacing*{\subsection}{1cm}{10pt}{0cm}

\usepackage{longtable}
\usepackage{array}
\usepackage{ragged2e}
\newcolumntype{P}[1]{>{\RaggedRight\arraybackslash}p{#1}}
\renewcommand{\arraystretch}{1.15} % opsional: spasi baris tabel sedikit lega

% TAMBAHAN: Paket untuk indentasi berbeda
\usepackage{changepage}

% Environment untuk isi subsection dengan indentasi berbeda
\newenvironment{subsectcontent}{
...
\newenvironment{subsectlist}{
	\begin{adjustwidth}{1.5cm}{0pt}
		\setlength{\parindent}{1cm}
		% TANPA \indent karena langsung ke list
	}{
	\end{adjustwidth}
}
...
\usepackage{geometry}
\geometry{
	left=2.5cm,          % Margin kiri
	top=2.5cm,           % Margin atas
...
% Environment untuk section (indentasi normal)
...
% Environment untuk subsection (indentasi lebih dalam)
\newenvironment{packed_enum_sub}{ % Membuat lingkungan untuk daftar bernomor subsection
...
\newenvironment{packed_item_sub}{ % Membuat lingkungan untuk daftar berpoin subsection
