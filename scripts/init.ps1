...
PASSWORD=${GLOBAL_PASSWORD:-changeme}
NEO4J_AUTH=neo4j/${GLOBAL_PASSWORD:-changeme}
NEO4J_PASSWORD=${GLOBAL_PASSWORD:-changeme}
GRAFANA_ADMIN_PASSWORD=${GLOBAL_PASSWORD:-changeme}
AIRFLOW_ADMIN_PASSWORD=${GLOBAL_PASSWORD:-changeme}
POSTGRES_PASSWORD=${GLOBAL_PASSWORD:-changeme}
